  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved idea as @idea" do
        ...
        post :create, {:idea => { "user" => "invalid value" }}, valid_session
        assigns(:idea).should be_a_new(Idea)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested idea" do
        ...
        Idea.any_instance.should_receive(:update).with({ "user" => "" })
        put :update, {:id => idea.to_param, :idea => { "user" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the idea as @idea" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Idea.any_instance.stub(:save).and_return(false)
        put :update, {:id => idea.to_param, :idea => { "user" => "invalid value" }}, valid_session
        assigns(:idea).should eq(idea)
      end
